...
def main():
    ...
    parser.add_argument("--model", type=str, default="customcnn", choices=["mobilenetv3", "resnet50", "customcnn", "densenet121", "shufflenetv2", "squeezenet11", "regnety400"], help="Model architecture")
